            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item "><a href="{{ route('admin-desakel.peraturan-desa') }}">{{ $title }}</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('superadmin.peraturan-desa.detail', $result->id) }}"
                                    class="text-secondary mr-2">
                                @elseif (Auth::user()->role == 'admin_desakel')
                                    <a href="{{ route('admin-desakel.peraturan-desa.detail', $result->id) }}"
                                        class="text-secondary mr-2">
                                @endif
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin-desakel.evaluasi.update', $result->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')

                                <div class="form-group">
                                    <label for="judul_peraturan">Judul Peraturan <span class="text-danger">*</span></label>
                                    <input type="text" name="judul_peraturan" id="judul_peraturan" class="form-control @error('judul_peraturan') is-invalid @enderror" value="{{ old('judul_peraturan', $result->judul_peraturan) }}" placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_peraturan_id" id="jenis_peraturan_id" class="form-control select2 @error('jenis_peraturan_id') is-invalid @enderror" style="width: 100%;">
                                        ...
                                        @foreach ($jenis_peraturans as $jp)
                                            <option value="{{ $jp->id }}" @if ($result->jenis_peraturan_id == $jp->id) selected @endif>{{ $jp->jenis_aturan }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="isi_peraturan" id="isi_peraturan" class="form-control @error('isi_peraturan') is-invalid @enderror">{{ $result->isi_peraturan }}</textarea>
                                    @error('isi_peraturan')
                                        <span class="error invalid-feedback">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="hidden" name="file_lama" value="{{ $result->file }}">
                                        ...
                                        <div class="input-group-append">
                                            <a href="{{ asset($result->file) }}" target="_blank">
                                                <span class="input-group-text"><i class="fas fa-file-alt"></i> &nbsp; File Sebelumnya</span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_penyusun" id="nama_penyusun" class="form-control @error('nama_penyusun') is-invalid @enderror" value="{{ old('nama_penyusun', $result->nama_penyusun) }}" placeholder="...">
                                    @error('nama_penyusun')
                                        <span class="error invalid-feedback">
                                            {{ $message }}
                                        </span>
