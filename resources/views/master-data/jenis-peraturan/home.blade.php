                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('superadmin.jenis-peraturan.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle"></i> Tambah Data</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="example1" class="table table-sm table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $result->jenis_aturan }}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('superadmin.jenis-peraturan.edit', $result->id) }}"
                                                    class="btn btn-sm text-white btn-warning mr-2"><i
                                                    class="fas fa-edit"></i> Edit</a>
                                                    <form method="POST" action="{{ route('superadmin.jenis-peraturan.destroy', $result->id) }}">
                                                        @csrf
