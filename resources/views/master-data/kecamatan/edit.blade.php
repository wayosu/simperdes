            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('superadmin.kecamatan.update', $data->id) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    <label for="nama_kecamatan">Nama Kecamatan</label>
                                    <input type="text" name="nama_kecamatan" id="nama_kecamatan" class="form-control @error('nama_kecamatan') is-invalid @enderror" value="{{ old('nama_kecamatan', $data->nama_kecamatan) }}" placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_camat" id="nama_camat" class="form-control @error('nama_camat') is-invalid @enderror" value="{{ old('nama_camat', $data->nama_camat) }}" placeholder="...">
                                    @error('nama_camat')
                                        <span class="error invalid-feedback">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kabupaten_kota_id" id="kabupaten_kota_id" class="form-control select2 @error('kabupaten_kota_id') is-invalid @enderror" style="width: 100%;">
                                        ...
                                        @foreach ($kabupaten_kotas as $result)
                                            <option value="{{ $result->id }}" @if($data->kabupaten_kota_id == $result->id) selected @endif>{{ $result->nama_kabupaten_kota }}, {{ $result->provinsi->nama_provinsi }}</option>
                                        @endforeach
                                    </select>
