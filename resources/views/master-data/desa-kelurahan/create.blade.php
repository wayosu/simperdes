            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('superadmin.desa-kelurahan.store') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="nama_desa_kelurahan">Nama Desa Kelurahan</label>
                                    <input type="text" name="nama_desa_kelurahan" id="nama_desa_kelurahan" class="form-control @error('nama_desa_kelurahan') is-invalid @enderror" value="{{ old('nama_desa_kelurahan') }}" placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kepala_desa" id="nama_kepala_desa" class="form-control @error('nama_kepala_desa') is-invalid @enderror" value="{{ old('nama_kepala_desa') }}" placeholder="...">
